...
type ParticipantRepository interface {
	...
	DeleteParticipantByIDs(int64, int64) error
}
...
func (s *DBService) DeleteParticipantByIDs(userId, teamId int64) error {
	if _, err := s.DB.Exec("DELETE FROM participant WHERE user_id=$1 AND team_id=$2", userId, teamId); err != nil {
		return err
	}
	return nil
}
